...
// Used only when the API returns empty headers for a provider
// that is known to require one. Otherwise we trust data.headers
// as-is, since header requirements vary per show/episode.
// ==========================================
